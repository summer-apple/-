						...
						<div class="panel-body">
							...
							<form id="add-form" role="form" class="form-horizontal" action="" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									<textarea id="description" name="description" class="form-control wysihtml5" data-stylesheet-url="../resources/js/wysihtml5/lib/css/wysiwyg-color.css" name="sample_wysiwyg" id="sample_wysiwyg"></textarea>
									</div>
								</div>
