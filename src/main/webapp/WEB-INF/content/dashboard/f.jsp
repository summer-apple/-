...
<body class="page-body">
					...
					<div class="user-info">
						...
						<div class="user-image">
							<a href="extra-profile.html">
								<img src="resources/images/user-2.png" class="img-responsive img-circle" />
							</a>
						</div>
			...
			<nav class="navbar user-info-navbar" role="navigation">
				...
				<ul class="user-info-menu right-links list-inline list-unstyled">
					...
					<li class="dropdown user-profile">
						<a href="#" data-toggle="dropdown">
							<img src="resources/images/user-4.png" alt="user-image" class="img-circle img-inline userpic-32" width="28" />
							<span>
								Arlind Nushi
	...
	<link rel="stylesheet" href="resources/js/daterangepicker/daterangepicker-bs3.css">
	...
	<link rel="stylesheet" href="resources/js/multiselect/css/multi-select.css">
	...
	<script src="resources/js/tagsinput/bootstrap-tagsinput.min.js"></script>
